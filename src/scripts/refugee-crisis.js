window.addEventListener('DOMContentLoaded', function () {
	...
	var BASEDIR = container.attr('data-basedir') || '';
	...
	queue()
		...
		.await(function (error, geo, applications) {
			...
			legend.append('p').append('small').html('June data estimated for Cyprus.<br>Statistical data from <a href="http://appsso.eurostat.ec.europa.eu/nui/show.do?dataset=migr_asyappctzm">Eurostat</a>; geographical data from <a href="http://www.naturalearthdata.com/downloads/50m-cultural-vectors/50m-admin-0-countries-2/">Natural Earth</a>.');
